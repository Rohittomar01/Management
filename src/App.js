  ...
  return (
    ...
    <Router>
      ...
      <Route element={<OurTeam />} path={"/OurTeam"}></Route>
        ...
        <Route element={<RegistrationPage />} path={"/RegistrationPage"}></Route>
        ...
        <Route element={<TechventureEvent />} path={"/TechventureEvent/*"}></Route>
        ...
        <Route element={<StudentSigninPage />} path={"/StudentSigninPage"}></Route>
