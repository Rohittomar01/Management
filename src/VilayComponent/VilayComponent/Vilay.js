            ...
            <div>
                ...
                <div id='events'> </div>
                    <div className={classes.ribinbg} >
                        <h1 className="d-flex justify-content-center mt-0 abouth1color  pt-3  ribinbg"> &nbsp;&nbsp;&nbsp; About Us
                            &nbsp;
                            &nbsp;&nbsp;</h1>
                    </div>
                <div className="main-back-cont" style={{background:"#fff",height:"80vh"}}>
...
It provides a platform for various innovative competitions like singing, dancing, music, mimicry, acting, poetry, rangoli , poster making and the like. Based on socially relevant themes and carrying value-based messages the students imbibe values while enjoying the fest. Students are bestowed with prizes and certificates to recognize their efforts and celebrate their talents.</p>
                ...
                <div>
                    ...
                    <div className={classes.ribinbg} style={{marginTop:"-3%"}} >
                        <h1 className="d-flex justify-content-center mt-0 abouth1color  pt-3  ribinbg"> &nbsp;&nbsp;&nbsp; Event's
                            &nbsp;
                            &nbsp;&nbsp;</h1>
                    </div>
